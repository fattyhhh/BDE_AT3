...
left join {{ ref('room_stg')}} d on a.room_type = d.room_type and a.scraped_date::timestamp between d.dbt_valid_from and coalesce(d.dbt_valid_to, '9999-12-31'::timestamp)
